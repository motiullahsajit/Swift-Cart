...
const Reviews = () => {
  return (
    <div className="my-10 w-[1320px] mx-auto flex gap-3">
      <div className="flex w-[432px] h-[242px] flex-col items-center justify-center gap-4 border-[1px] border-[#BABABA] rounded-2xl">
        ...
        <p className="text-[#003F62] text-[13px] w-[395px] h-[82px] bg-[#E2F4FF] rounded-2xl px-6 py-3 overflow-hidden">
