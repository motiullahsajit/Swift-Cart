...
export const getPieCharts = TryCatch(async (req, res, next) => {
    ...
    if (nodeCache.has(key)) {
        ...
        const [processingOrders, shippedOrders, deliveredOrders, categories, productsCount, productOutOfStock, allOrders, allUsers, adminUsers, customerUsers,] = await Promise.all([
